...
st.markdown('<div class="report">PROJECT_01</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">CUSTOMER</div>', unsafe_allow_html=True)
st.markdown('<div class="main-title">SEGMENTATION<br>RFM analysis technique </div>', unsafe_allow_html=True)
...
st.image("static/project01_business_problem.png", use_container_width =True)
